"""Azure Architecture Agent — Agent Orchestrator (Plan → Research → Execute → Validate → Respond)."""
...
class AgentOrchestrator:
    """Orchestrates the Azure Architecture Agent through a multi-step pipeline.
