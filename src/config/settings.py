"""Application configuration for Azure Architecture Agent."""
...
class Settings(BaseSettings):
    ...
    app_name: str = Field(default="azure-architecture-agent", description="Application name")
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/azure_architecture_agent",
    ...
    vector_store_type: str = Field(default="azure_ai_search", description="Vector store type")
    opensearch_url: str = Field(default="https://localhost:9200", description="OpenSearch URL")
    opensearch_index: str = Field(default="azure_architecture_agent_vectors", description="Index")
    ...
    mcp_server_name: str = Field(default="azure-architecture-agent-mcp", description="MCP server name")

    a2a_discovery_url: str = Field(default="http://localhost:8500", description="A2A discovery URL")
    a2a_agent_id: str = Field(default="azure-architecture-agent", description="A2A agent ID")
