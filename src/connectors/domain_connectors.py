"""Azure Architecture Agent - Domain-Specific Connectors."""
...
class TerraformCliConnector:
    """Domain-specific connector for terraform cli integration with Azure Architecture Agent."""
...
class AwsProviderConnector:
    """Domain-specific connector for aws provider integration with Azure Architecture Agent."""
...
class AzureProviderConnector:
    """Domain-specific connector for azure provider integration with Azure Architecture Agent."""
...
class GcpProviderConnector:
    """Domain-specific connector for gcp provider integration with Azure Architecture Agent."""
...
class InfracostConnector:
    """Domain-specific connector for infracost integration with Azure Architecture Agent."""
