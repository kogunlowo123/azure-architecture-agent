"""Azure Architecture Agent - Unit Tests."""
...
async def test_design_architecture():
    """Test Design cloud architecture for Azure Architecture Agent."""
    tools = AgentTools()
...
async def test_agent_initialization():
    ...
    from src.agent.azure_architecture_agent_agent import AzureArchitectureAgentAgent
    agent = AzureArchitectureAgentAgent()
